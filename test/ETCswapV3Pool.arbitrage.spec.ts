...
import { ETCswapV3PoolSwapTest } from '../typechain/ETCswapV3PoolSwapTest'
...
describe('ETCswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('ETCswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as ETCswapV3PoolSwapTest
          ...
          let tester: ETCswapV3PoolSwapTest
