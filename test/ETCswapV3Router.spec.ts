...
describe('ETCswapV3Pool', () => {
  ...
  let pool0: MockTimeETCswapV3Pool
  let pool1: MockTimeETCswapV3Pool
  ...
  let swapTargetCallee: TestETCswapV3Callee
  let swapTargetRouter: TestETCswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeETCswapV3Pool, any]> => {
